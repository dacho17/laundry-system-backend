...
public interface IBookingService {
	List<ActivityHistoryEntryDto> getUserActivities() throws EntryNotFoundException, DbException;
	List<TimeslotAvailabilityDto> getLaundryAssetsEarliestAvailability() throws EntryNotFoundException, DbException;
	PurchaseDto purchaseLaundryService(int assetId, boolean isPayingWithLoyaltyPoints) throws DbException, EntryNotFoundException, ApiBadRequestException;
